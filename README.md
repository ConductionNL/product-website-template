...
| `SLACK_URL`                                 | `"false"`                                                                                        | The URL for your Slack workspace. If left `"false"` then the slack icon will not be shown.                                 |
| `READ_THE_DOCS_URL`                         | `"false"`                                                                                        | The URL for your Read the Docs documentation. If left `"false"` then the documentation icon will not be shown.             |
